...
public class Scopes extends CFacade {
	 ...
	 * </ul>
	 */
	public static final long[] __DNA__FIELD___pad = new long[]{5244, 5260};
	...
	public CArrayFacade<Byte> get_pad() throws IOException
	{
		...
		if ((__io__pointersize == 8)) {
			return new CArrayFacade<Byte>(__io__address + 5260, __dna__targetTypes, __dna__dimensions, __io__block, __io__blockTable);
		} else {
			return new CArrayFacade<Byte>(__io__address + 5244, __dna__targetTypes, __dna__dimensions, __io__block, __io__blockTable);
		}
	}
