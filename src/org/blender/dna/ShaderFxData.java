...
public class ShaderFxData extends CFacade {
	 ...
	 * <pre>
	 * ShaderFxData shaderfxdata = ...;
	 * CPointer&lt;Object&gt; p = shaderfxdata.__dna__addressof(ShaderFxData.__DNA__FIELD__stackindex);
	 ...
	 * <pre>
	 * ShaderFxData shaderfxdata = ...;
	 * CPointer&lt;Object&gt; p = shaderfxdata.__dna__addressof(ShaderFxData.__DNA__FIELD___pad);
	...
	public CPointer<ShaderFxData> getNext() throws IOException
	{
		...
		Class<?>[] __dna__targetTypes = new Class[]{ShaderFxData.class};
		return new CPointer<ShaderFxData>(__dna__targetAddress, __dna__targetTypes, __io__blockTable.getBlock(__dna__targetAddress, ShaderFxData.__DNA__SDNA_INDEX), __io__blockTable);
	}
	...
	public void setNext(CPointer<ShaderFxData> next) throws IOException
	{
	...
	public CPointer<ShaderFxData> getPrev() throws IOException
	{
		long __dna__targetAddress;
		if ((__io__pointersize == 8)) {
	...
	public void setPrev(CPointer<ShaderFxData> prev) throws IOException
	{
	...
	public CPointer<ShaderFxData> __io__addressof() {
		return new CPointer<ShaderFxData>(__io__address, new Class[]{ShaderFxData.class}, __io__block, __io__blockTable);
	}
