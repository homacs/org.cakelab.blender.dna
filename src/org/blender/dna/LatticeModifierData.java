...
public class LatticeModifierData extends CFacade {
	 ...
	 * </ul>
	 */
	public static final long[] __DNA__FIELD__strength = new long[]{164, 184};
	 ...
	 * <pre>
	 * LatticeModifierData latticemodifierdata = ...;
	 * CPointer&lt;Object&gt; p = latticemodifierdata.__dna__addressof(LatticeModifierData.__DNA__FIELD__pad);
	...
	{
		if ((__io__pointersize == 8)) {
			__io__block.writeFloat(__io__address + 184, strength);
		} else {
			__io__block.writeFloat(__io__address + 164, strength);
		}
	}
