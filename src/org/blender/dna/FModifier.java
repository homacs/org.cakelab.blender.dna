...
public class FModifier extends CFacade {
	 ...
	 * <pre>
	 * FModifier fmodifier = ...;
	 * CPointer&lt;Object&gt; p = fmodifier.__dna__addressof(FModifier.__DNA__FIELD__edata);
	 * CPointer&lt;CPointer&lt;Object&gt;&gt; p_edata = p.cast(new Class[]{CPointer.class, Object.class});
	 * </pre>
	 * <h3>Metadata</h3>
	 * <ul>
	 * <li>Field: 'edata'</li>
	 ...
	 * </ul>
	 */
	public static final long[] __DNA__FIELD__edata = new long[]{12, 24};
	...
	public CPointer<Object> getEdata() throws IOException
	{
		long __dna__targetAddress;
		if ((__io__pointersize == 8)) {
	...
	public void setEdata(CPointer<Object> edata) throws IOException
	{
		long __address = ((edata == null) ? 0 : edata.getAddress());
		if ((__io__pointersize == 8)) {
