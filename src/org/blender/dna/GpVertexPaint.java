...
/**
 * Generated facet for DNA struct type 'GpVertexPaint'.
 * 
 * <h3>Class Documentation</h3>
 * 
 * <h4>Blender Source Code</h4>
 * <p> Grease pencil vertex paint. </p>
 */

@CMetaData(size32=76, size64=96)
public class GpVertexPaint extends CFacade {

	/**
	 * This is the sdna index of the struct GpVertexPaint.
	 * <p>
	 * It is required when allocating a new block to store data for GpVertexPaint.
	 * </p>
	 * @see StructDNA
	 * @see BlockTable
	 */
	 ...
	 * </p>
	 * <pre>
	 * GpVertexPaint gpvertexpaint = ...;
	 * CPointer&lt;Object&gt; p = gpvertexpaint.__dna__addressof(GpVertexPaint.__DNA__FIELD__paint);
	 ...
	 * <pre>
	 * GpVertexPaint gpvertexpaint = ...;
	 * CPointer&lt;Object&gt; p = gpvertexpaint.__dna__addressof(GpVertexPaint.__DNA__FIELD__flag);
	 ...
	 * <pre>
	 * GpVertexPaint gpvertexpaint = ...;
	 * CPointer&lt;Object&gt; p = gpvertexpaint.__dna__addressof(GpVertexPaint.__DNA__FIELD___pad);
	 ...
	 * </ul>
	 */
	public static final long[] __DNA__FIELD___pad = new long[]{72, 92};

	public GpVertexPaint(long __address, Block __block, BlockTable __blockTable) {
		super(__address, __block, __blockTable);
	}

	protected GpVertexPaint(GpVertexPaint that) {
	 ...
	 */
	public CPointer<GpVertexPaint> __io__addressof() {
		return new CPointer<GpVertexPaint>(__io__address, new Class[]{GpVertexPaint.class}, __io__block, __io__blockTable);
	}
