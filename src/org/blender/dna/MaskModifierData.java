...
public class MaskModifierData extends CFacade {
	 ...
	 * </ul>
	 */
	public static final long[] __DNA__FIELD__ob_arm = new long[]{104, 120};
	 ...
	 * </ul>
	 */
	public static final long[] __DNA__FIELD__vgroup = new long[]{108, 128};
	 ...
	 * </ul>
	 */
	public static final long[] __DNA__FIELD__threshold = new long[]{176, 196};
	...
	public void setThreshold(float threshold) throws IOException
	{
		if ((__io__pointersize == 8)) {
			...
			__io__block.writeFloat(__io__address + 176, threshold);
		}
	}
