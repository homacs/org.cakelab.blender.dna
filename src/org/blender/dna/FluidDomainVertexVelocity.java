...
public class FluidDomainVertexVelocity extends CFacade {
	...
	public FluidDomainVertexVelocity(long __address, Block __block, BlockTable __blockTable) {
		super(__address, __block, __blockTable);
	}

	protected FluidDomainVertexVelocity(FluidDomainVertexVelocity that) {
	 ...
	 */
	public CPointer<FluidDomainVertexVelocity> __io__addressof() {
		return new CPointer<FluidDomainVertexVelocity>(__io__address, new Class[]{FluidDomainVertexVelocity.class}, __io__block, __io__blockTable);
	}
