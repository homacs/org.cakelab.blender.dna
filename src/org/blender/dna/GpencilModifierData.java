...
public class GpencilModifierData extends CFacade {
	...
	public CPointer<GpencilModifierData> getNext() throws IOException
	{
		...
		Class<?>[] __dna__targetTypes = new Class[]{GpencilModifierData.class};
		return new CPointer<GpencilModifierData>(__dna__targetAddress, __dna__targetTypes, __io__blockTable.getBlock(__dna__targetAddress, GpencilModifierData.__DNA__SDNA_INDEX), __io__blockTable);
	}
	...
	public void setNext(CPointer<GpencilModifierData> next) throws IOException
	{
	...
	public CPointer<GpencilModifierData> getPrev() throws IOException
	{
		long __dna__targetAddress;
		if ((__io__pointersize == 8)) {
	...
	public void setPrev(CPointer<GpencilModifierData> prev) throws IOException
	{
	...
	public CPointer<GpencilModifierData> __io__addressof() {
		return new CPointer<GpencilModifierData>(__io__address, new Class[]{GpencilModifierData.class}, __io__block, __io__blockTable);
	}
