...
public class AssetTag extends CFacade {
	...
	public AssetTag(long __address, Block __block, BlockTable __blockTable) {
	...
	public CPointer<AssetTag> getNext() throws IOException
	{
		...
		Class<?>[] __dna__targetTypes = new Class[]{AssetTag.class};
		return new CPointer<AssetTag>(__dna__targetAddress, __dna__targetTypes, __io__blockTable.getBlock(__dna__targetAddress, AssetTag.__DNA__SDNA_INDEX), __io__blockTable);
	}
	...
	public void setNext(CPointer<AssetTag> next) throws IOException
	{
	...
	public CPointer<AssetTag> getPrev() throws IOException
	{
		long __dna__targetAddress;
		if ((__io__pointersize == 8)) {
	...
	public void setPrev(CPointer<AssetTag> prev) throws IOException
	{
	...
	public CPointer<AssetTag> __io__addressof() {
		return new CPointer<AssetTag>(__io__address, new Class[]{AssetTag.class}, __io__block, __io__blockTable);
	}
