...
public class bChildOfConstraint extends CFacade {

	/**
	 * This is the sdna index of the struct bChildOfConstraint.
	 * <p>
	 ...
	 * CPointer&lt;Object&gt; p = bchildofconstraint.__dna__addressof(bChildOfConstraint.__DNA__FIELD__tar);
	 ...
	 * <pre>
	 * bChildOfConstraint bchildofconstraint = ...;
	 * CPointer&lt;Object&gt; p = bchildofconstraint.__dna__addressof(bChildOfConstraint.__DNA__FIELD__flag);
	 ...
	 * <pre>
	 * bChildOfConstraint bchildofconstraint = ...;
	 * CPointer&lt;Object&gt; p = bchildofconstraint.__dna__addressof(bChildOfConstraint.__DNA__FIELD__invmat);
	 ...
	 * </ul>
	 */
	public static final long[] __DNA__FIELD__invmat = new long[]{12, 16};
	 ...
	 * <pre>
	 * bChildOfConstraint bchildofconstraint = ...;
	 * CPointer&lt;Object&gt; p = bchildofconstraint.__dna__addressof(bChildOfConstraint.__DNA__FIELD__subtarget);
	 ...
	 * </ul>
	 */
	public static final long[] __DNA__FIELD__subtarget = new long[]{76, 80};

	public bChildOfConstraint(long __address, Block __block, BlockTable __blockTable) {
		super(__address, __block, __blockTable);
	}

	protected bChildOfConstraint(bChildOfConstraint that) {
	...
	public CArrayFacade<CArrayFacade<Float>> getInvmat() throws IOException
	{
		...
		if ((__io__pointersize == 8)) {
			return new CArrayFacade<CArrayFacade<Float>>(__io__address + 16, __dna__targetTypes, __dna__dimensions, __io__block, __io__blockTable);
		} else {
	 ...
	 */
	public CPointer<bChildOfConstraint> __io__addressof() {
		return new CPointer<bChildOfConstraint>(__io__address, new Class[]{bChildOfConstraint.class}, __io__block, __io__blockTable);
	}
