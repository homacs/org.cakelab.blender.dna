...
public class bSizeLimitConstraint extends CFacade {
	...
	public bSizeLimitConstraint(long __address, Block __block, BlockTable __blockTable) {
		super(__address, __block, __blockTable);
	}

	protected bSizeLimitConstraint(bSizeLimitConstraint that) {
	 ...
	 */
	public CPointer<bSizeLimitConstraint> __io__addressof() {
		return new CPointer<bSizeLimitConstraint>(__io__address, new Class[]{bSizeLimitConstraint.class}, __io__block, __io__blockTable);
	}
