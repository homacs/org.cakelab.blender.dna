...
public class RigidBodyCon extends CFacade {
	 ...
	 * <h3>Metadata</h3>
	 * <ul>
	 * <li>Field: 'spring_type'</li>
	 * <li>Signature: 'char'</li>
	 * <li>Actual Size (32bit/64bit): 1/1</li>
	 * </ul>
	 */
	public static final long[] __DNA__FIELD__spring_type = new long[]{20, 28};
	 ...
	 * </ul>
	 */
	public static final long[] __DNA__FIELD___pad = new long[]{21, 29};
	...
	public byte getSpring_type() throws IOException
	{
		if ((__io__pointersize == 8)) {
	...
	public void setSpring_type(byte spring_type) throws IOException
	{
		if ((__io__pointersize == 8)) {
			__io__block.writeByte(__io__address + 28, spring_type);
		} else {
			__io__block.writeByte(__io__address + 20, spring_type);
		}
	}
