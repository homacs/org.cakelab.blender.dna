 ...
 * <p> Damped Tracking constraint </p>
 */

@CMetaData(size32=76, size64=80)
public class bDampTrackConstraint extends CFacade {

	/**
	 * This is the sdna index of the struct bDampTrackConstraint.
	 * <p>
	 * It is required when allocating a new block to store data for bDampTrackConstraint.
	 * </p>
	 ...
	 * </p>
	 * <pre>
	 * bDampTrackConstraint bdamptrackconstraint = ...;
	 * CPointer&lt;Object&gt; p = bdamptrackconstraint.__dna__addressof(bDampTrackConstraint.__DNA__FIELD__tar);
	 ...
	 * <pre>
	 * bDampTrackConstraint bdamptrackconstraint = ...;
	 * CPointer&lt;Object&gt; p = bdamptrackconstraint.__dna__addressof(bDampTrackConstraint.__DNA__FIELD__trackflag);
	 ...
	 * <pre>
	 * bDampTrackConstraint bdamptrackconstraint = ...;
	 * CPointer&lt;Object&gt; p = bdamptrackconstraint.__dna__addressof(bDampTrackConstraint.__DNA__FIELD___pad);
	 ...
	 * <pre>
	 * bDampTrackConstraint bdamptrackconstraint = ...;
	 * CPointer&lt;Object&gt; p = bdamptrackconstraint.__dna__addressof(bDampTrackConstraint.__DNA__FIELD__subtarget);
	...
	public bDampTrackConstraint(long __address, Block __block, BlockTable __blockTable) {
		super(__address, __block, __blockTable);
	}

	protected bDampTrackConstraint(bDampTrackConstraint that) {
	 ...
	 */
	public CPointer<bDampTrackConstraint> __io__addressof() {
		return new CPointer<bDampTrackConstraint>(__io__address, new Class[]{bDampTrackConstraint.class}, __io__block, __io__blockTable);
	}
