...
public class uiFontStyle extends CFacade {
	 ...
	 * <pre>
	 * uiFontStyle uifontstyle = ...;
	 * CPointer&lt;Object&gt; p = uifontstyle.__dna__addressof(uiFontStyle.__DNA__FIELD___pad1);
	 ...
	 * CPointer&lt;Float&gt; p_points = p.cast(new Class[]{Float.class});
	 * </pre>
	 * <h3>Metadata</h3>
	 * <ul>
	 * <li>Field: 'points'</li>
	 ...
	 * </ul>
	 */
	public static final long[] __DNA__FIELD__points = new long[]{4, 4};
	 ...
	 * </ul>
	 */
	public static final long[] __DNA__FIELD__italic = new long[]{8, 8};
	 ...
	 * </ul>
	 */
	public static final long[] __DNA__FIELD__bold = new long[]{10, 10};
	 ...
	 * </ul>
	 */
	public static final long[] __DNA__FIELD__shadow = new long[]{12, 12};
	 ...
	 * </ul>
	 */
	public static final long[] __DNA__FIELD__shadx = new long[]{14, 14};
	 ...
	 * </ul>
	 */
	public static final long[] __DNA__FIELD__shady = new long[]{16, 16};
	 ...
	 * </ul>
	 */
	public static final long[] __DNA__FIELD___pad0 = new long[]{18, 18};
	 ...
	 * </ul>
	 */
	public static final long[] __DNA__FIELD__shadowalpha = new long[]{20, 20};
	 ...
	 * </ul>
	 */
	public static final long[] __DNA__FIELD__shadowcolor = new long[]{24, 24};
	 ...
	 * <pre>
	 * uiFontStyle uifontstyle = ...;
	 * CPointer&lt;Object&gt; p = uifontstyle.__dna__addressof(uiFontStyle.__DNA__FIELD___pad2);
	...
	public float getPoints() throws IOException
	{
		if ((__io__pointersize == 8)) {
	...
	public void setPoints(float points) throws IOException
	{
		if ((__io__pointersize == 8)) {
			__io__block.writeFloat(__io__address + 4, points);
		} else {
			__io__block.writeFloat(__io__address + 4, points);
		}
	}
	...
	{
		if ((__io__pointersize == 8)) {
			__io__block.writeShort(__io__address + 8, italic);
		} else {
			__io__block.writeShort(__io__address + 8, italic);
		}
	}
	...
	{
		if ((__io__pointersize == 8)) {
			__io__block.writeShort(__io__address + 10, bold);
		} else {
			__io__block.writeShort(__io__address + 10, bold);
		}
	}
	...
	{
		if ((__io__pointersize == 8)) {
			__io__block.writeShort(__io__address + 12, shadow);
		} else {
			__io__block.writeShort(__io__address + 12, shadow);
		}
	}
	...
	{
		if ((__io__pointersize == 8)) {
			__io__block.writeShort(__io__address + 14, shadx);
		} else {
			__io__block.writeShort(__io__address + 14, shadx);
		}
	}
	...
	{
		if ((__io__pointersize == 8)) {
			__io__block.writeShort(__io__address + 16, shady);
		} else {
			__io__block.writeShort(__io__address + 16, shady);
		}
	}
	...
	{
		if ((__io__pointersize == 8)) {
			__io__block.writeFloat(__io__address + 20, shadowalpha);
		} else {
			__io__block.writeFloat(__io__address + 20, shadowalpha);
		}
	}
	...
	{
		if ((__io__pointersize == 8)) {
			__io__block.writeFloat(__io__address + 24, shadowcolor);
		} else {
			__io__block.writeFloat(__io__address + 24, shadowcolor);
		}
	}
