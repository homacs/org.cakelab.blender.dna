...
/**
 * Generated facet for DNA struct type 'NodeInputColor'.
 * 
...
public class NodeInputColor extends CFacade {

	/**
	 * This is the sdna index of the struct NodeInputColor.
	 * <p>
	 * It is required when allocating a new block to store data for NodeInputColor.
	 * </p>
	 * @see StructDNA
	 * @see BlockTable
	 */
	 ...
	 * </p>
	 * <pre>
	 * NodeInputColor nodeinputcolor = ...;
	 * CPointer&lt;Object&gt; p = nodeinputcolor.__dna__addressof(NodeInputColor.__DNA__FIELD__color);
	...
	public NodeInputColor(long __address, Block __block, BlockTable __blockTable) {
		super(__address, __block, __blockTable);
	}

	protected NodeInputColor(NodeInputColor that) {
	 ...
	 */
	public CPointer<NodeInputColor> __io__addressof() {
		return new CPointer<NodeInputColor>(__io__address, new Class[]{NodeInputColor.class}, __io__block, __io__blockTable);
	}
