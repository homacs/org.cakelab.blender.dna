 ...
 * <p> Copy Location Constraint </p>
 */

@CMetaData(size32=76, size64=80)
public class bLocateLikeConstraint extends CFacade {

	/**
	 * This is the sdna index of the struct bLocateLikeConstraint.
	 * <p>
	 * It is required when allocating a new block to store data for bLocateLikeConstraint.
	 * </p>
	 ...
	 * CPointer&lt;Object&gt; p = blocatelikeconstraint.__dna__addressof(bLocateLikeConstraint.__DNA__FIELD__tar);
	 ...
	 * <pre>
	 * bLocateLikeConstraint blocatelikeconstraint = ...;
	 * CPointer&lt;Object&gt; p = blocatelikeconstraint.__dna__addressof(bLocateLikeConstraint.__DNA__FIELD__flag);
	 ...
	 * <pre>
	 * bLocateLikeConstraint blocatelikeconstraint = ...;
	 * CPointer&lt;Object&gt; p = blocatelikeconstraint.__dna__addressof(bLocateLikeConstraint.__DNA__FIELD__reserved1);
	 ...
	 * <pre>
	 * bLocateLikeConstraint blocatelikeconstraint = ...;
	 * CPointer&lt;Object&gt; p = blocatelikeconstraint.__dna__addressof(bLocateLikeConstraint.__DNA__FIELD__subtarget);
	...
	public bLocateLikeConstraint(long __address, Block __block, BlockTable __blockTable) {
		super(__address, __block, __blockTable);
	}

	protected bLocateLikeConstraint(bLocateLikeConstraint that) {
	 ...
	 */
	public CPointer<bLocateLikeConstraint> __io__addressof() {
		return new CPointer<bLocateLikeConstraint>(__io__address, new Class[]{bLocateLikeConstraint.class}, __io__block, __io__blockTable);
	}
