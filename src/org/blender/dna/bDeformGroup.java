 ...
 * <p> Vertex Groups - Name Info </p>
 */

@CMetaData(size32=80, size64=88)
public class bDeformGroup extends CFacade {
	 ...
	 * <h3>Field Documentation</h3>
	 * <h4>Blender Source Code:</h4>
	 * <p> need this flag for locking weights </p>
	 * <h3>Pointer Arithmetics</h3>
	 * <p>
	 * This is how you get a reference on the corresponding field in the struct:
	 * </p>
	 ...
	 * <pre>
	 * bDeformGroup bdeformgroup = ...;
	 * CPointer&lt;Object&gt; p = bdeformgroup.__dna__addressof(bDeformGroup.__DNA__FIELD__pad);
	 ...
	 * </ul>
	 */
	public static final long[] __DNA__FIELD__pad = new long[]{73, 81};

	public bDeformGroup(long __address, Block __block, BlockTable __blockTable) {
	...
	public CPointer<bDeformGroup> getNext() throws IOException
	{
		...
		Class<?>[] __dna__targetTypes = new Class[]{bDeformGroup.class};
		return new CPointer<bDeformGroup>(__dna__targetAddress, __dna__targetTypes, __io__blockTable.getBlock(__dna__targetAddress, bDeformGroup.__DNA__SDNA_INDEX), __io__blockTable);
	}
	...
	public void setNext(CPointer<bDeformGroup> next) throws IOException
	{
	...
	public CPointer<bDeformGroup> getPrev() throws IOException
	{
		long __dna__targetAddress;
		if ((__io__pointersize == 8)) {
	...
	public void setPrev(CPointer<bDeformGroup> prev) throws IOException
	{
	...
	public CPointer<bDeformGroup> __io__addressof() {
		return new CPointer<bDeformGroup>(__io__address, new Class[]{bDeformGroup.class}, __io__block, __io__blockTable);
	}
