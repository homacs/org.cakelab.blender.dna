...
/**
 * Generated facet for DNA struct type 'LineStyleThicknessModifier_Material'.
 * 
...
public class LineStyleThicknessModifier_Material extends CFacade {

	/**
	 * This is the sdna index of the struct LineStyleThicknessModifier_Material.
	 * <p>
	 * It is required when allocating a new block to store data for LineStyleThicknessModifier_Material.
	 * </p>
	 * @see StructDNA
	 * @see BlockTable
	 */
	public static final int __DNA__SDNA_INDEX = 745;
	 ...
	 * </p>
	 * <pre>
	 * LineStyleThicknessModifier_Material linestylethicknessmodifier_material = ...;
	 * CPointer&lt;Object&gt; p = linestylethicknessmodifier_material.__dna__addressof(LineStyleThicknessModifier_Material.__DNA__FIELD__modifier);
	 ...
	 * <pre>
	 * LineStyleThicknessModifier_Material linestylethicknessmodifier_material = ...;
	 * CPointer&lt;Object&gt; p = linestylethicknessmodifier_material.__dna__addressof(LineStyleThicknessModifier_Material.__DNA__FIELD__curve);
	 ...
	 * <pre>
	 * LineStyleThicknessModifier_Material linestylethicknessmodifier_material = ...;
	 * CPointer&lt;Object&gt; p = linestylethicknessmodifier_material.__dna__addressof(LineStyleThicknessModifier_Material.__DNA__FIELD__flags);
	 ...
	 * <pre>
	 * LineStyleThicknessModifier_Material linestylethicknessmodifier_material = ...;
	 * CPointer&lt;Object&gt; p = linestylethicknessmodifier_material.__dna__addressof(LineStyleThicknessModifier_Material.__DNA__FIELD__value_min);
	 ...
	 * <pre>
	 * LineStyleThicknessModifier_Material linestylethicknessmodifier_material = ...;
	 * CPointer&lt;Object&gt; p = linestylethicknessmodifier_material.__dna__addressof(LineStyleThicknessModifier_Material.__DNA__FIELD__value_max);
	...
	/**
	 * Field descriptor (offset) for struct member 'mat_attr'.
	 * <h3>Pointer Arithmetics</h3>
	 * <p>
	 * This is how you get a reference on the corresponding field in the struct:
	 * </p>
	 * <pre>
	 * LineStyleThicknessModifier_Material linestylethicknessmodifier_material = ...;
	 * CPointer&lt;Object&gt; p = linestylethicknessmodifier_material.__dna__addressof(LineStyleThicknessModifier_Material.__DNA__FIELD__mat_attr);
	 * CPointer&lt;Integer&gt; p_mat_attr = p.cast(new Class[]{Integer.class});
	 * </pre>
	 * <h3>Metadata</h3>
	 * <ul>
	 * <li>Field: 'mat_attr'</li>
	 * <li>Signature: 'int'</li>
	 * <li>Actual Size (32bit/64bit): 4/4</li>
	 * </ul>
	 */
	public static final long[] __DNA__FIELD__mat_attr = new long[]{104, 116};

	public LineStyleThicknessModifier_Material(long __address, Block __block, BlockTable __blockTable) {
		super(__address, __block, __blockTable);
	}

	protected LineStyleThicknessModifier_Material(LineStyleThicknessModifier_Material that) {
	...
	/**
	 * Get method for struct member 'mat_attr'.
	 * @see #__DNA__FIELD__mat_attr
	 */
	
	public int getMat_attr() throws IOException
	{
		if ((__io__pointersize == 8)) {
	...
	/**
	 * Set method for struct member 'mat_attr'.
	 * @see #__DNA__FIELD__mat_attr
	 */
	
	public void setMat_attr(int mat_attr) throws IOException
	{
		if ((__io__pointersize == 8)) {
			__io__block.writeInt(__io__address + 116, mat_attr);
		} else {
			__io__block.writeInt(__io__address + 104, mat_attr);
		}
	}
	 ...
	 */
	public CPointer<LineStyleThicknessModifier_Material> __io__addressof() {
		return new CPointer<LineStyleThicknessModifier_Material>(__io__address, new Class[]{LineStyleThicknessModifier_Material.class}, __io__block, __io__blockTable);
	}
