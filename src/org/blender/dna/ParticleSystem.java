...
@CMetaData(size32=540, size64=664)
public class ParticleSystem extends CFacade {
	...
	/**
	 * Field descriptor (offset) for struct member 'frand'.
	 * <h3>Pointer Arithmetics</h3>
	 * <p>
	 * This is how you get a reference on the corresponding field in the struct:
	 * </p>
	 * <pre>
	 * ParticleSystem particlesystem = ...;
	 * CPointer&lt;Object&gt; p = particlesystem.__dna__addressof(ParticleSystem.__DNA__FIELD__frand);
	 * CPointer&lt;CPointer&lt;Float&gt;&gt; p_frand = p.cast(new Class[]{CPointer.class, Float.class});
	 * </pre>
	 * <h3>Metadata</h3>
	 * <ul>
	 * <li>Field: 'frand'</li>
	 ...
	 * </ul>
	 */
	public static final long[] __DNA__FIELD__frand = new long[]{528, 648};
	 ...
	 * </ul>
	 */
	public static final long[] __DNA__FIELD__dt_frac = new long[]{532, 656};
	 ...
	 * </ul>
	 */
	public static final long[] __DNA__FIELD___pad = new long[]{536, 660};
	...
	/**
	 * Get method for struct member 'frand'.
	 * @see #__DNA__FIELD__frand
	 */
	
	public CPointer<Float> getFrand() throws IOException
	{
		long __dna__targetAddress;
		if ((__io__pointersize == 8)) {
	...
	/**
	 * Set method for struct member 'frand'.
	 * @see #__DNA__FIELD__frand
	 */
	
	public void setFrand(CPointer<Float> frand) throws IOException
	{
		long __address = ((frand == null) ? 0 : frand.getAddress());
		if ((__io__pointersize == 8)) {
	...
	public void setDt_frac(float dt_frac) throws IOException
	{
		if ((__io__pointersize == 8)) {
			...
			__io__block.writeFloat(__io__address + 532, dt_frac);
		}
	}
	...
	{
		if ((__io__pointersize == 8)) {
			__io__block.writeFloat(__io__address + 660, _pad);
		} else {
			__io__block.writeFloat(__io__address + 536, _pad);
		}
	}
