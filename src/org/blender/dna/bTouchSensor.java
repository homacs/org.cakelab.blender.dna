...
public class bTouchSensor extends CFacade {
	 ...
	 * </p>
	 * <pre>
	 * bTouchSensor btouchsensor = ...;
	 * CPointer&lt;Object&gt; p = btouchsensor.__dna__addressof(bTouchSensor.__DNA__FIELD__name);
	 ...
	 * <pre>
	 * bTouchSensor btouchsensor = ...;
	 * CPointer&lt;Object&gt; p = btouchsensor.__dna__addressof(bTouchSensor.__DNA__FIELD__ma);
	 * CPointer&lt;CPointer&lt;Material&gt;&gt; p_ma = p.cast(new Class[]{CPointer.class, Material.class});
	 * </pre>
	 * <h3>Metadata</h3>
	 * <ul>
	 * <li>Field: 'ma'</li>
	 ...
	 * </ul>
	 */
	public static final long[] __DNA__FIELD__ma = new long[]{64, 64};
	 ...
	 * <pre>
	 * bTouchSensor btouchsensor = ...;
	 * CPointer&lt;Object&gt; p = btouchsensor.__dna__addressof(bTouchSensor.__DNA__FIELD__dist);
	 ...
	 * <pre>
	 * bTouchSensor btouchsensor = ...;
	 * CPointer&lt;Object&gt; p = btouchsensor.__dna__addressof(bTouchSensor.__DNA__FIELD__pad);
	 ...
	 * @see #__DNA__FIELD__ma
	 */
	
	public CPointer<Material> getMa() throws IOException
	{
	...
	public void setMa(CPointer<Material> ma) throws IOException
	{
		long __address = ((ma == null) ? 0 : ma.getAddress());
		if ((__io__pointersize == 8)) {
	...
	{
		if ((__io__pointersize == 8)) {
			__io__block.writeFloat(__io__address + 76, pad);
		} else {
	...
	public CPointer<bTouchSensor> __io__addressof() {
		return new CPointer<bTouchSensor>(__io__address, new Class[]{bTouchSensor.class}, __io__block, __io__blockTable);
	}
