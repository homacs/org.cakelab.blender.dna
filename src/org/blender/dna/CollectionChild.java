...
public class CollectionChild extends CFacade {
	 ...
	 * <ul>
	 * <li>Field: 'next'</li>
	 * <li>Signature: 'CollectionChild*'</li>
	...
	public CPointer<CollectionChild> getNext() throws IOException
	{
		...
		Class<?>[] __dna__targetTypes = new Class[]{CollectionChild.class};
		return new CPointer<CollectionChild>(__dna__targetAddress, __dna__targetTypes, __io__blockTable.getBlock(__dna__targetAddress, CollectionChild.__DNA__SDNA_INDEX), __io__blockTable);
	}
	...
	public void setNext(CPointer<CollectionChild> next) throws IOException
	{
	...
	public CPointer<CollectionChild> getPrev() throws IOException
	{
		long __dna__targetAddress;
		if ((__io__pointersize == 8)) {
	...
	public void setPrev(CPointer<CollectionChild> prev) throws IOException
	{
	...
	public CPointer<CollectionChild> __io__addressof() {
		return new CPointer<CollectionChild>(__io__address, new Class[]{CollectionChild.class}, __io__block, __io__blockTable);
	}
