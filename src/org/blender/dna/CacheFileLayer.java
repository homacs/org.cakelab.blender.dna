...
public class CacheFileLayer extends CFacade {
	 ...
	 * <ul>
	 * <li>Field: 'next'</li>
	 * <li>Signature: 'CacheFileLayer*'</li>
	 ...
	 * </ul>
	 */
	public static final long[] __DNA__FIELD__filepath = new long[]{8, 16};
	 ...
	 * </ul>
	 */
	public static final long[] __DNA__FIELD__flag = new long[]{1032, 1040};
	 ...
	 * </ul>
	 */
	public static final long[] __DNA__FIELD___pad = new long[]{1036, 1044};
	...
	public CPointer<CacheFileLayer> getNext() throws IOException
	{
		...
		Class<?>[] __dna__targetTypes = new Class[]{CacheFileLayer.class};
		return new CPointer<CacheFileLayer>(__dna__targetAddress, __dna__targetTypes, __io__blockTable.getBlock(__dna__targetAddress, CacheFileLayer.__DNA__SDNA_INDEX), __io__blockTable);
	}
	...
	public void setNext(CPointer<CacheFileLayer> next) throws IOException
	{
	...
	public CPointer<CacheFileLayer> getPrev() throws IOException
	{
		long __dna__targetAddress;
		if ((__io__pointersize == 8)) {
	...
	public void setPrev(CPointer<CacheFileLayer> prev) throws IOException
	{
	...
	{
		if ((__io__pointersize == 8)) {
			return __io__block.readInt(__io__address + 1040);
		} else {
			return __io__block.readInt(__io__address + 1032);
		}
	}
	...
	{
		if ((__io__pointersize == 8)) {
			__io__block.writeInt(__io__address + 1040, flag);
		} else {
			__io__block.writeInt(__io__address + 1032, flag);
		}
	}
	...
	{
		if ((__io__pointersize == 8)) {
			__io__block.writeInt(__io__address + 1044, _pad);
		} else {
			__io__block.writeInt(__io__address + 1036, _pad);
		}
	}
	...
	public CPointer<CacheFileLayer> __io__addressof() {
		return new CPointer<CacheFileLayer>(__io__address, new Class[]{CacheFileLayer.class}, __io__block, __io__blockTable);
	}
