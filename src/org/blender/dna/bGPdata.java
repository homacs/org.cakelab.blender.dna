...
public class bGPdata extends CFacade {
	 ...
	 * </ul>
	 */
	public static final long[] __DNA__FIELD__layers = new long[]{100, 120};
	 ...
	 * </ul>
	 */
	public static final long[] __DNA__FIELD__flag = new long[]{108, 136};
	 ...
	 * </ul>
	 */
	public static final long[] __DNA__FIELD__sbuffer_size = new long[]{112, 140};
	 ...
	 * </ul>
	 */
	public static final long[] __DNA__FIELD__sbuffer_sflag = new long[]{114, 142};
	 ...
	 * </ul>
	 */
	public static final long[] __DNA__FIELD__sbuffer = new long[]{116, 144};
	...
	{
		if ((__io__pointersize == 8)) {
			__io__block.writeShort(__io__address + 140, sbuffer_size);
		} else {
			__io__block.writeShort(__io__address + 112, sbuffer_size);
		}
	}
	...
	{
		if ((__io__pointersize == 8)) {
			__io__block.writeShort(__io__address + 142, sbuffer_sflag);
		} else {
			__io__block.writeShort(__io__address + 114, sbuffer_sflag);
		}
	}
