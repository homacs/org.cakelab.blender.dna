...
public class TriangulateModifierData extends CFacade {
	 ...
	 * </ul>
	 */
	public static final long[] __DNA__FIELD__quad_method = new long[]{116, 140};
	 ...
	 * </ul>
	 */
	public static final long[] __DNA__FIELD__ngon_method = new long[]{120, 144};
	 ...
	 * </ul>
	 */
	public static final long[] __DNA__FIELD__min_vertices = new long[]{124, 148};
	...
	{
		if ((__io__pointersize == 8)) {
			__io__block.writeInt(__io__address + 140, quad_method);
		} else {
	...
	{
		if ((__io__pointersize == 8)) {
			__io__block.writeInt(__io__address + 144, ngon_method);
		} else {
	...
	{
		if ((__io__pointersize == 8)) {
			__io__block.writeInt(__io__address + 148, min_vertices);
		} else {
			__io__block.writeInt(__io__address + 124, min_vertices);
		}
	}
