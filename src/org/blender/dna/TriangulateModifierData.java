...
public class TriangulateModifierData extends CFacade {
	 ...
	 * </ul>
	 */
	public static final long[] __DNA__FIELD__quad_method = new long[]{108, 124};
	 ...
	 * </ul>
	 */
	public static final long[] __DNA__FIELD__ngon_method = new long[]{112, 128};
	 ...
	 * </ul>
	 */
	public static final long[] __DNA__FIELD__min_vertices = new long[]{116, 132};
	...
	public void setQuad_method(int quad_method) throws IOException
	{
		if ((__io__pointersize == 8)) {
			...
			__io__block.writeInt(__io__address + 108, quad_method);
		}
	}
	...
	public void setNgon_method(int ngon_method) throws IOException
	{
		if ((__io__pointersize == 8)) {
			...
			__io__block.writeInt(__io__address + 112, ngon_method);
		}
	}
	...
	public void setMin_vertices(int min_vertices) throws IOException
	{
		if ((__io__pointersize == 8)) {
			...
			__io__block.writeInt(__io__address + 116, min_vertices);
		}
	}
