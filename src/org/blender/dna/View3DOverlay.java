...
public class View3DOverlay extends CFacade {
	 ...
	 * </ul>
	 */
	public static final long[] __DNA__FIELD__sculpt_mode_face_sets_opacity = new long[]{40, 40};
	 ...
	 * </ul>
	 */
	public static final long[] __DNA__FIELD__fade_alpha = new long[]{48, 48};
	 ...
	 * </ul>
	 */
	public static final long[] __DNA__FIELD__wireframe_threshold = new long[]{52, 52};
	 ...
	 * </ul>
	 */
	public static final long[] __DNA__FIELD__wireframe_opacity = new long[]{56, 56};
	 ...
	 * </ul>
	 */
	public static final long[] __DNA__FIELD__gpencil_paper_opacity = new long[]{60, 60};
	 ...
	 * </ul>
	 */
	public static final long[] __DNA__FIELD__gpencil_grid_opacity = new long[]{64, 64};
	 ...
	 * </ul>
	 */
	public static final long[] __DNA__FIELD__gpencil_fade_layer = new long[]{68, 68};
	 ...
	 * </ul>
	 */
	public static final long[] __DNA__FIELD__gpencil_vertex_paint_opacity = new long[]{72, 72};
	 ...
	 * </ul>
	 */
	public static final long[] __DNA__FIELD__handle_display = new long[]{76, 76};
	...
	{
		if ((__io__pointersize == 8)) {
			__io__block.writeFloat(__io__address + 40, sculpt_mode_face_sets_opacity);
		} else {
			__io__block.writeFloat(__io__address + 40, sculpt_mode_face_sets_opacity);
		}
	}
	...
	{
		if ((__io__pointersize == 8)) {
			__io__block.writeFloat(__io__address + 48, fade_alpha);
		} else {
			__io__block.writeFloat(__io__address + 48, fade_alpha);
		}
	}
	...
	{
		if ((__io__pointersize == 8)) {
			__io__block.writeFloat(__io__address + 52, wireframe_threshold);
		} else {
			__io__block.writeFloat(__io__address + 52, wireframe_threshold);
		}
	}
	...
	{
		if ((__io__pointersize == 8)) {
			__io__block.writeFloat(__io__address + 56, wireframe_opacity);
		} else {
			__io__block.writeFloat(__io__address + 56, wireframe_opacity);
		}
	}
	...
	{
		if ((__io__pointersize == 8)) {
			__io__block.writeFloat(__io__address + 60, gpencil_paper_opacity);
		} else {
			__io__block.writeFloat(__io__address + 60, gpencil_paper_opacity);
		}
	}
	...
	{
		if ((__io__pointersize == 8)) {
			__io__block.writeFloat(__io__address + 64, gpencil_grid_opacity);
		} else {
			__io__block.writeFloat(__io__address + 64, gpencil_grid_opacity);
		}
	}
	...
	{
		if ((__io__pointersize == 8)) {
			__io__block.writeFloat(__io__address + 68, gpencil_fade_layer);
		} else {
			__io__block.writeFloat(__io__address + 68, gpencil_fade_layer);
		}
	}
	...
	{
		if ((__io__pointersize == 8)) {
			__io__block.writeFloat(__io__address + 72, gpencil_vertex_paint_opacity);
		} else {
			__io__block.writeFloat(__io__address + 72, gpencil_vertex_paint_opacity);
		}
	}
	...
	{
		if ((__io__pointersize == 8)) {
			__io__block.writeInt(__io__address + 76, handle_display);
		} else {
			__io__block.writeInt(__io__address + 76, handle_display);
		}
	}
