...
/**
 * Generated facet for DNA struct type 'GpSculptPaint'.
 * 
 * <h3>Class Documentation</h3>
 * 
 * <h4>Blender Source Code</h4>
 * <p> Grease pencil sculpt paint. </p>
 */

@CMetaData(size32=76, size64=96)
public class GpSculptPaint extends CFacade {

	/**
	 * This is the sdna index of the struct GpSculptPaint.
	 * <p>
	 * It is required when allocating a new block to store data for GpSculptPaint.
	 * </p>
	 * @see StructDNA
	 * @see BlockTable
	 */
	 ...
	 * </p>
	 * <pre>
	 * GpSculptPaint gpsculptpaint = ...;
	 * CPointer&lt;Object&gt; p = gpsculptpaint.__dna__addressof(GpSculptPaint.__DNA__FIELD__paint);
	 ...
	 * <pre>
	 * GpSculptPaint gpsculptpaint = ...;
	 * CPointer&lt;Object&gt; p = gpsculptpaint.__dna__addressof(GpSculptPaint.__DNA__FIELD__flag);
	 ...
	 * <pre>
	 * GpSculptPaint gpsculptpaint = ...;
	 * CPointer&lt;Object&gt; p = gpsculptpaint.__dna__addressof(GpSculptPaint.__DNA__FIELD___pad);
	...
	public GpSculptPaint(long __address, Block __block, BlockTable __blockTable) {
		super(__address, __block, __blockTable);
	}

	protected GpSculptPaint(GpSculptPaint that) {
	 ...
	 */
	public CPointer<GpSculptPaint> __io__addressof() {
		return new CPointer<GpSculptPaint>(__io__address, new Class[]{GpSculptPaint.class}, __io__block, __io__blockTable);
	}
