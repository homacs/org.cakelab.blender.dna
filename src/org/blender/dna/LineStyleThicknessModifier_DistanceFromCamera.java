...
/**
 * Generated facet for DNA struct type 'LineStyleThicknessModifier_DistanceFromCamera'.
 * 
...
public class LineStyleThicknessModifier_DistanceFromCamera extends CFacade {

	/**
	 * This is the sdna index of the struct LineStyleThicknessModifier_DistanceFromCamera.
	 * <p>
	 * It is required when allocating a new block to store data for LineStyleThicknessModifier_DistanceFromCamera.
	 * </p>
	 ...
	 * </p>
	 * <pre>
	 * LineStyleThicknessModifier_DistanceFromCamera linestylethicknessmodifier_distancefromcamera = ...;
	 * CPointer&lt;Object&gt; p = linestylethicknessmodifier_distancefromcamera.__dna__addressof(LineStyleThicknessModifier_DistanceFromCamera.__DNA__FIELD__modifier);
	 ...
	 * <pre>
	 * LineStyleThicknessModifier_DistanceFromCamera linestylethicknessmodifier_distancefromcamera = ...;
	 * CPointer&lt;Object&gt; p = linestylethicknessmodifier_distancefromcamera.__dna__addressof(LineStyleThicknessModifier_DistanceFromCamera.__DNA__FIELD__curve);
	 ...
	 * <pre>
	 * LineStyleThicknessModifier_DistanceFromCamera linestylethicknessmodifier_distancefromcamera = ...;
	 * CPointer&lt;Object&gt; p = linestylethicknessmodifier_distancefromcamera.__dna__addressof(LineStyleThicknessModifier_DistanceFromCamera.__DNA__FIELD__flags);
	 ...
	 * <pre>
	 * LineStyleThicknessModifier_DistanceFromCamera linestylethicknessmodifier_distancefromcamera = ...;
	 * CPointer&lt;Object&gt; p = linestylethicknessmodifier_distancefromcamera.__dna__addressof(LineStyleThicknessModifier_DistanceFromCamera.__DNA__FIELD__range_min);
	 ...
	 * </ul>
	 */
	public static final long[] __DNA__FIELD__range_min = new long[]{96, 108};
	 ...
	 * <pre>
	 * LineStyleThicknessModifier_DistanceFromCamera linestylethicknessmodifier_distancefromcamera = ...;
	 * CPointer&lt;Object&gt; p = linestylethicknessmodifier_distancefromcamera.__dna__addressof(LineStyleThicknessModifier_DistanceFromCamera.__DNA__FIELD__range_max);
	 ...
	 * </ul>
	 */
	public static final long[] __DNA__FIELD__range_max = new long[]{100, 112};
	 ...
	 * <pre>
	 * LineStyleThicknessModifier_DistanceFromCamera linestylethicknessmodifier_distancefromcamera = ...;
	 * CPointer&lt;Object&gt; p = linestylethicknessmodifier_distancefromcamera.__dna__addressof(LineStyleThicknessModifier_DistanceFromCamera.__DNA__FIELD__value_min);
	 ...
	 * </ul>
	 */
	public static final long[] __DNA__FIELD__value_min = new long[]{104, 116};
	 ...
	 * <pre>
	 * LineStyleThicknessModifier_DistanceFromCamera linestylethicknessmodifier_distancefromcamera = ...;
	 * CPointer&lt;Object&gt; p = linestylethicknessmodifier_distancefromcamera.__dna__addressof(LineStyleThicknessModifier_DistanceFromCamera.__DNA__FIELD__value_max);
	 ...
	 * </ul>
	 */
	public static final long[] __DNA__FIELD__value_max = new long[]{108, 120};
	 ...
	 * <pre>
	 * LineStyleThicknessModifier_DistanceFromCamera linestylethicknessmodifier_distancefromcamera = ...;
	 * CPointer&lt;Object&gt; p = linestylethicknessmodifier_distancefromcamera.__dna__addressof(LineStyleThicknessModifier_DistanceFromCamera.__DNA__FIELD__pad);
	 ...
	 * </ul>
	 */
	public static final long[] __DNA__FIELD__pad = new long[]{112, 124};

	public LineStyleThicknessModifier_DistanceFromCamera(long __address, Block __block, BlockTable __blockTable) {
		super(__address, __block, __blockTable);
	}

	protected LineStyleThicknessModifier_DistanceFromCamera(LineStyleThicknessModifier_DistanceFromCamera that) {
	...
	{
		if ((__io__pointersize == 8)) {
			__io__block.writeFloat(__io__address + 108, range_min);
		} else {
	...
	{
		if ((__io__pointersize == 8)) {
			__io__block.writeFloat(__io__address + 112, range_max);
		} else {
	...
	{
		if ((__io__pointersize == 8)) {
			__io__block.writeFloat(__io__address + 116, value_min);
		} else {
			__io__block.writeFloat(__io__address + 104, value_min);
		}
	}
	...
	{
		if ((__io__pointersize == 8)) {
			__io__block.writeFloat(__io__address + 120, value_max);
		} else {
			__io__block.writeFloat(__io__address + 108, value_max);
		}
	}
	 ...
	 */
	public CPointer<LineStyleThicknessModifier_DistanceFromCamera> __io__addressof() {
		return new CPointer<LineStyleThicknessModifier_DistanceFromCamera>(__io__address, new Class[]{LineStyleThicknessModifier_DistanceFromCamera.class}, __io__block, __io__blockTable);
	}
