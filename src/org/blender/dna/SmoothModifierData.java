...
/**
 * Generated facet for DNA struct type 'SmoothModifierData'.
 * 
...
public class SmoothModifierData extends CFacade {
	 ...
	 * CPointer&lt;Object&gt; p = smoothmodifierdata.__dna__addressof(SmoothModifierData.__DNA__FIELD__modifier);
	 ...
	 * <pre>
	 * SmoothModifierData smoothmodifierdata = ...;
	 * CPointer&lt;Object&gt; p = smoothmodifierdata.__dna__addressof(SmoothModifierData.__DNA__FIELD__fac);
	 ...
	 * </ul>
	 */
	public static final long[] __DNA__FIELD__fac = new long[]{96, 112};
	 ...
	 * <pre>
	 * SmoothModifierData smoothmodifierdata = ...;
	 * CPointer&lt;Object&gt; p = smoothmodifierdata.__dna__addressof(SmoothModifierData.__DNA__FIELD__defgrp_name);
	 ...
	 * </ul>
	 */
	public static final long[] __DNA__FIELD__defgrp_name = new long[]{100, 116};
	 ...
	 * <pre>
	 * SmoothModifierData smoothmodifierdata = ...;
	 * CPointer&lt;Object&gt; p = smoothmodifierdata.__dna__addressof(SmoothModifierData.__DNA__FIELD__flag);
	 ...
	 * <pre>
	 * SmoothModifierData smoothmodifierdata = ...;
	 * CPointer&lt;Object&gt; p = smoothmodifierdata.__dna__addressof(SmoothModifierData.__DNA__FIELD__repeat);
	 ...
	 * </ul>
	 */
	public static final long[] __DNA__FIELD__repeat = new long[]{166, 182};
	...
	{
		if ((__io__pointersize == 8)) {
			__io__block.writeFloat(__io__address + 112, fac);
		} else {
			__io__block.writeFloat(__io__address + 96, fac);
		}
	}
	...
	{
		if ((__io__pointersize == 8)) {
			__io__block.writeShort(__io__address + 182, repeat);
		} else {
			__io__block.writeShort(__io__address + 166, repeat);
		}
	}
	...
	public CPointer<SmoothModifierData> __io__addressof() {
		return new CPointer<SmoothModifierData>(__io__address, new Class[]{SmoothModifierData.class}, __io__block, __io__blockTable);
	}
