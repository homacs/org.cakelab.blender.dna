...
public class VolumeToMeshModifierData extends CFacade {
	 ...
	 * </ul>
	 */
	public static final long[] __DNA__FIELD__adaptivity = new long[]{116, 140};
	 ...
	 * </ul>
	 */
	public static final long[] __DNA__FIELD__resolution_mode = new long[]{124, 148};
	 ...
	 * </ul>
	 */
	public static final long[] __DNA__FIELD__voxel_amount = new long[]{132, 156};
	 ...
	 * </ul>
	 */
	public static final long[] __DNA__FIELD__grid_name = new long[]{136, 160};
	...
	public void setAdaptivity(float adaptivity) throws IOException
	{
		if ((__io__pointersize == 8)) {
			...
			__io__block.writeFloat(__io__address + 116, adaptivity);
		}
	}
	...
	{
		if ((__io__pointersize == 8)) {
			__io__block.writeInt(__io__address + 148, resolution_mode);
		} else {
			__io__block.writeInt(__io__address + 124, resolution_mode);
		}
	}
	...
	{
		if ((__io__pointersize == 8)) {
			__io__block.writeInt(__io__address + 156, voxel_amount);
		} else {
			__io__block.writeInt(__io__address + 132, voxel_amount);
		}
	}
